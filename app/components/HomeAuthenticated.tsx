...
import { createThreadTextContainer, postThreadTextContainer } from '../lib/threads-api/threads-posts/actions';
...
const HomeAuthenticated: React.FC<HomeAuthenticatedProps> = async ({ access_token }) => {
    ...
    async function postThreadAction (formData: FormData) {
        ...
        try {
            ...
            await postThreadTextContainer(threadsContainerId, access_token);
        } catch (error) {
